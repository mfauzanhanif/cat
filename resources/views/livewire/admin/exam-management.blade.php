    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <flux:text class="mt-1 text-zinc-500">Setup jadwal ujian dan pengaturan</flux:text>
            </div>
                        ...
                        <flux:table.row>
                            ...
                            <flux:table.cell class="text-right">
                                ...
                                <flux:button
                                    ...
                                    wire:confirm="Yakin ingin menghapus ujian ini? Semua data sesi ujian akan ikut terhapus."
                                    size="sm"
                                    variant="ghost"
                                    icon="trash"
